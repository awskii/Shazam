...
func main() {
	var s = flag.String("s", "", "string to encode")
	var f = flag.String("f", "", "file to encode")
	var d = flag.String("d", "", "string to decode")
